...
#                SOURCE                #
#--------------------------------------#
SRC_URI = "${SOURCEFORGE_MIRROR}/${BPN}/${BP}.tar.bz2;name=source                   \
           file://parallel-make-archives.patch                                      \
           file://lib-Makefile-fix-parallel-issue.patch                             \
           file://0001-Mark-our-explicit-fall-through-so-Wextra-will-work-i.patch   \
           "

SRC_URI[source.md5sum] = "1f719c9c135778aa6b087b89a1cc2423"
SRC_URI[source.sha256sum] = "bd8fcd5914f18fc0e4ba948ab03b00013e528504f529c60739b748f6ef130b22"
