...
#                SOURCE                #
#--------------------------------------#
SRC_URI = "http://linux-pam.org/library/Linux-PAM-${PV}.tar.bz2;name=source \
           file://99_pam                                                    \
...
SRC_URI[source.md5sum] = "da4b2289b7cfb19583d54e9eaaef1c3a"
SRC_URI[source.sha256sum] = "241aed1ef522f66ed672719ecf2205ec513fd0075ed80cda8e086a5b1a01d1bb"
...
#           DEPENDS/PROVIDES           #
#--------------------------------------#
DEPENDS        = " gettext-native bison-native flex-native libxml2-native "
DEPENDS_append = " virtual/gettext flex cracklib "
